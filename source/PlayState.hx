...
class PlayState extends MusicBeatState
{
	...
	var mapperEngineWatermark:FlxText;
	...
	override public function create()
	{
		...
		// Add MapperHX Engine watermark
		mapperEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - MHX " + MainMenuState.mapperHXVer : ""), 16);
		mapperEngineWatermark.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		mapperEngineWatermark.scrollFactor.set();
		add(mapperEngineWatermark);

		if (FlxG.save.data.downscroll)
			mapperEngineWatermark.y = FlxG.height * 0.9 + 45;
		...
		mapperEngineWatermark.cameras = [camHUD];
		if (loadRep)
	...
	override public function update(elapsed:Float)
	{
		...
		if (executeModchart && luaModchart != null && songStarted)
		{
			...
			if (luaModchart.getVar("showOnlyStrums",'bool'))
			{
				...
				mapperEngineWatermark.visible = false;
			...
			else
			{
				...
				mapperEngineWatermark.visible = true;
